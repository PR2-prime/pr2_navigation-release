...
The packages in the `pr2_navigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release pr2_navigation --track kinetic --ros-distro kinetic --edit` on `Thu, 26 Apr 2018 08:42:47 -0000`
